...
@app.route('/login') #ruta 2
def login():
    return '<body bgcolor="white"><center> <h1 style="color: red;">Registrate</h1>   <br><form action="ejemplo.php" method="get"> <p>Nombre: <input type="text"  size="40"></p> <p>Contraseña: <input></p></br><a href="http://127.0.0.1:5000/"><button href>Iniciar sesion</button> </a></center> '
